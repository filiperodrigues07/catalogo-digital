...
// Função para abrir o WhatsApp com uma mensagem de pedido
function enviarPedido(produto, preco) {
    const numeroWhatsapp = "5549991525885"; // Insira seu número de WhatsApp aqui
    const mensagem = `Olá, gostaria de pedir um ${produto} no valor de R$ ${preco}.`;
